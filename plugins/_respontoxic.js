...
✾ *Script By ᴀʟꜰɪɪᴛᴢʏ ᴅᴇᴠ*

✾ *OFFICIAL GROUP*
_https://chat.whatsapp.com/HJrUd0ivcmZEjVzHhHsZZN

✾ *YOUTUBE OFFICIAL*
https://youtube.com/channel/UCOt2KJ3zAodg8NJv9NGoNxw
━━━━━━ꕥ`
  let _muptime
    if (process.send) {
      process.send('uptime')
        ...
        contextInfo: {
            externalAdReply: {
                mediaUrl: '',
                        ...
                        thumbnail: await (await fetch(`https://i.ibb.co/M5zdTWt/20221025-115823.jpg`)).buffer(),
